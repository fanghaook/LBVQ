...
from lbvq import add_lbvq_config
from predictor import VisualizationDemo


# constants
WINDOW_NAME = "lbvq video demo"
...
def get_parser():
    parser = argparse.ArgumentParser(description="lbvq demo for builtin configs")
    parser.add_argument(
        "--config-file",
        default="configs/youtubevis_2019/lbvq_R50_bs8.yaml",
        metavar="FILE",
