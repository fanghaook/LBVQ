...
class LbvqSetCriterion(nn.Module):
    ...
    def loss_masks(self, outputs, targets, indices, num_masks):
        ...
        losses = {
            "loss_lbvq_mask": sigmoid_ce_loss_jit(point_logits, point_labels, num_masks),
            "loss_lbvq_dice": dice_loss_jit(point_logits, point_labels, num_masks),
        }
    ...
    def loss_fg_sim(
        ...
        return {"loss_lbvq_sim": loss_clip_sim}
    ...
    def get_loss(
        ...
        loss_map = {
            'lbvq_labels': self.loss_labels,
            'lbvq_masks': self.loss_masks,
