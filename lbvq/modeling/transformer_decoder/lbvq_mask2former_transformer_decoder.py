...
class LbvqMultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.lbvq_last_layer_num = lbvq_last_layer_num
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["lbvq_last_layer_num"] = cfg.MODEL.LBVQ.LAST_LAYER_NUM
    ...
    def forward(self, x, mask_features, clip_mask_features, mask = None):
        ...
        num_layer         = self.lbvq_last_layer_num if self.training else 1
